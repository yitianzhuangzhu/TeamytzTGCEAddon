...
/**
 * 炮塔动物瞄准按钮（仿照科技枪 GuiButtonTargetAnimals）
 * 图标取自 turret_base_gui.png：动物图标 UV (176, 6/22)，16x16
 */
public class GuiButtonTargetAnimals extends GuiButtonExt {
    ...
    public GuiButtonTargetAnimals(int id, int xPos, int yPos, int width, int height, TurretBaseTileEntMaster tile) {
